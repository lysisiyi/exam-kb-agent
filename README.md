...
3 科 × 3 模板（真题全卷 22 题 / 突击模考 11 题 / 错题专练 15 题）。
...
```
app/lib     71 个文件   25000+ 行   （不含 drift 生成产物）
app/test    34 个文件   12000+ 行   （602 个用例，全部通过）
```
